...
<p>
    <a class="btn btn-success" href="/products"><i style='font-size:20px' class='fas'>&#xf359;</i>Back to product list</a>
</p>
        ...
        <div class="col-9">
            <form action="/products?action=update" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="product_name" name="name_product" value="${product.getNameProduct()}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="amount" name="amount" value="${product.getAmount()}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="id_category" name="id_categogy">
                        <c:forEach var="type" items="${categoryList}">
                            <option ${type.idCategory == product.idCategory ? 'selected' : ''} value="${type.idCategory}">${type.nameCategory}</option>
                        </c:forEach>
                    </select>
                </div>
